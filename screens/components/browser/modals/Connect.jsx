...
const Connect = props => {
  ...
  return (
    <>
      <Text style={[styles.header, {color: colors.text_01}]}>
        Connect Account
      </Text>
      ...
      <View style={[styles.container, {backgroundColor: colors.transparent}]}>
        ...
        <View style={styles.box}>
          {props.webviewUrl.startsWith('https://') && (
            <MaterialIcons
              name="https"
              size={16}
        ...
        <Text style={[styles.info, {color: colors.text_02}]}>
          By touching connect, you allow this dapp to get your public address.
          Be careful about connecting to dapps you don't trust and always check
          the URL.
        </Text>
        <Text style={[styles.infoHeader, {color: colors.text_01}]}>
          {props.domain} would like to connect to your wallet.
        </Text>
        <View style={[styles.accountCard, {borderColor: colors.border_01}]}>
          <Image
          ...
          <View style={styles.accountCardView}>
            <Text
              ...
              {props.wallet.name} ({addressAbbreviate(props.wallet.address)}){' '}
            </Text>
            <Text
              style={{
              ...
              {props.wallet.balance} {props.network.nativeCurrency.symbol}{' '}
            </Text>
          </View>
        </View>
