        ...
        <View style={styles.btn}>
          <TouchableOpacity
            onPress={async () => {
              ...
              if (!show) {
                if (!mobileNumber || !accountNo || !ifscCode || !branch || !panNo) {
                 Alert.alert("Incomplete Details","Fill the form details properly.")
                } else {
                  setLoading(true);
            ...
            //       data: {rs: amount, type: {name: 'transfer'}},
            //       details: {
            //         ifscCode: ifscCode?.toUpperCase(),
            //         mobileNumber,
            //         name: validateResp.ben_name,
            //         accountNo,
            //       },
            //     });
            //   }
            ...
            {loading ? (
              ...
              <Text
                style={{
                  ...
                  textAlign: 'center',
                  color:
                    mobileNumber.length == 10 && accountNo && ifscCode
                      ? '#fff'
                      : '#000',
                }}>
                <AntDesign
