...
const ImportAccountByphrase = () => {
  ...
  async function verify(name, phrase) {
    ...
    if (name && name != '' && phrase && phrase != '') {
      ...
      try {
        if (phrase) {
          const account = await createAccount(name, wallets.length, phrase);
          const arr = [...wallets];
          arr?.push(account);
      ...
      AlertHelper.show(
        'error',
        'Import Wallet',
        'Please Provide Name and Private Key of your wallet',
      );
    }
  }
    ...
    <ScrollView style={{backgroundColor: '#fff'}}>      
      ...
      <KeyboardAvoidingView style={styles.inptcont}>
        <Text
          ...
          Enter Mnemonics or By Private Key
        </Text>
        ...
        <Text
          ...
          mnemonic phrases and private keys for all wallet types.
        </Text>
        ...
        <View style={[styles.password]}>
          ...
          <View style={styles.passwordView}>
            ...
            <View
              ...
              />
              <TouchableOpacity onPress={copyToClipboard} style={{paddingHorizontal: 10, paddingBottom:wp(2) ,alignItems:'flex-end'}}>
                <MaterialCommunityIcons name="line-scan" size={16} color="#000" />
              </TouchableOpacity>
            </View>
          </View>
        </View>
        ...
        <View style={styles.infowrapper}>
          <Text style={{color:'#000', marginBottom:wp(3)}}>
            Note
          </Text>
              ...
              <View style={styles.displayHori}>
                ...
                <Text style={styles.listItem}>
                  Nute Wallet will not record your Mnemonics or Private Keys. You control the access and assets.
                </Text>
              </View>
              <View style={styles.displayHori}>
                <Entypo name="dot-single" size={18} color={'#666'} />
                <Text style={styles.listItem}>
                 Please do not copy and paste the Mnemonics or Private Key to prevent the loss of assets due to third-party software monitoring.
                </Text>
              </View>
              <View style={styles.displayHori}>
                <Entypo name="dot-single" size={18} color={'#666'} />
                <Text style={styles.listItem}>
                 It is recommended that you manully input your Mnemonic or Private Key or scan the QR code to import.
                </Text>
              </View>
            </View>
