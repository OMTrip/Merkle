    ...
    <>
      ...
      style={{flex: 1,  paddingHorizontal: wp(5)}}>
        ...
        <View style={styles.lockWrapper}>
          <TouchableWithoutFeedback onPress={handlePress}>
            <View style={styles.InfoBox}>
              <View style={styles.InnerWrapper}>
                <Text style={styles.labelName}>English</Text>
          ...
          <View style={styles.InfoBox}>
            <View style={styles.InnerWrapper}>
              <Text style={styles.labelName}>Hindi</Text>
              <View style={styles.displayHori}>
                <View style={{marginEnd: wp(5)}}>
                  {/* {isSelected && (
          ...
          <View style={styles.InfoBox}>
            <View style={styles.InnerWrapper}>
              <Text style={styles.labelName}>Urdu</Text>
              <View style={styles.displayHori}>
                <View style={{marginEnd: wp(5)}}>
                  {/* {isSelected && (
                      <AntDesign name="check" size={18} color="#25d366" style={{fontWeight:'600'}}/>
          ...
          <View style={styles.InfoBox}>
            <View style={styles.InnerWrapper}>
              <Text style={styles.labelName}>Bengali</Text>
              <View style={styles.displayHori}>
                <View style={{marginEnd: wp(5)}}>
                  {/* {isSelected && (
                      <AntDesign name="check" size={18} color="#25d366" style={{fontWeight:'600'}}/>
          ...
          <View style={styles.InfoBox}>
            <View style={styles.InnerWrapper}>
              <Text style={styles.labelName}>Arabic</Text>
              <View style={styles.displayHori}>
                <View style={{marginEnd: wp(5)}}>
                  {/* {isSelected && (
                      <AntDesign name="check" size={18} color="#25d366" style={{fontWeight:'600'}}/>
          ...
          <View style={styles.InfoBox}>
            <View style={styles.InnerWrapper}>
              <Text style={styles.labelName}>Japneese</Text>
              <View style={styles.displayHori}>
                <View style={{marginEnd: wp(5)}}>
                  {/* {isSelected && (
                      <AntDesign name="check" size={18} color="#25d366" style={{fontWeight:'600'}}/>
