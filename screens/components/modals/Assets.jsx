    ...
    <>
      ...
      <TouchableOpacity
        ...
        <View
          ...
          <View
            ...
            <Text
              style={{textAlign: 'left', color: colors.text_02, fontSize: 13}}>
            ...
            <View style={{flexDirection: 'row', width: '100%'}}>
              <Image
                ...
                source={require('../../assets/coins/questions.jpeg')}
              />
              {/* <Image
                style={{
                  width: 24,
              ...
              <Image
                ...
                source={require('../../assets/coins/arbitrumc.png')}
              />
              <Image
                style={{
                  width: 24,
              ...
              <Image
                ...
                source={require('../../assets/coins/optimism.png')}
              /> */}
            </View>
          </View>
          <View
          ...
          <View
            ...
            <View style={{flexDirection: 'row', width: '100%'}}>
              <Image
                ...
                source={require('../../assets/coins/solana.png')}
              />
            </View>
          </View>
          <View
            ...
            <TouchableOpacity
              onPress={() => {
                ...
                AlertHelper.show(
                  'success',
                  'Copied to clipboard',
                  'Your Solana address has been copied to clipboard',
                );
              }}
              style={{
                backgroundColor: colors.ui_01,
      ...
      <BottomSheetModal
        ...
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
          <QRCode
            ...
            logo={
              address.startsWith('0x')
                ...
                : require('../../assets/coins/solana.png')
            }
          />
          <Text
            style={{
          ...
          <Text
            style={{color: colors.text_01, textAlign: 'center', width: '85%'}}>
            <Text style={{color: '#8e0000'}}> Note : </Text> Only deposit{' '}
            <Text style={{color: '#124e88'}}>" {network?.name} " </Text>Tokens
            to this address. otherwise your token will be lost forever.
          </Text>
        </View>
      </BottomSheetModal>
    </>
